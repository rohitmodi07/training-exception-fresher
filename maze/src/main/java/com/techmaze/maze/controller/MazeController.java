...
import com.techmaze.maze.exceptionhandling.ResourceNotFoundException;
...
public class MazeController {
	...
	public String getMazeDetailsReq(@RequestParam Map<String, String> det, @PathVariable("id") String pId) 
		...
		if("200".equalsIgnoreCase(pId)) {
			throw new ResourceNotFoundException("Resource not found for id :"+pId);
		}
